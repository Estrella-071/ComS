...
Computer science is a young discipline that is evolving and progressing. Computer networks have connected people from far-flung points of the globe. Virtual reality is creating 
...
as a self-study guide for interested professionals. As a textbook, it can be used for a one-semester or one-quarter course. It is designed as the first course in computer science. This 
...
- **Recommended reading**: This section gives a brief list of references relative to the chapter.
- **Key terms**: The new terms used in each chapter are listed at the end of the chapter and their definitions are included in the glossary.
- **Summary**: Each chapter ends with a summary of the material covered by that chapter.
- **Practice set**: Each chapter includes a practice set designed to reinforce salient concepts and encourage students to apply them. It consists of three parts: quizzes, questions, and problems.
...
電腦在我們的日常生活中扮演著重要的角色，並且在未來將繼續如此。
電腦科學是一門年輕且不斷發展進步的學科。電腦網路連接了全球各地的人們。虛擬實境創造出令人驚嘆的三維影像。太空探索的成功部分歸功於電腦。電腦生成的特效改變了電影工業。電腦在遺傳學中也扮演了重要的角色。
...
## 章末材料
每章結尾都有一套材料，包括以下內容：
- **推薦閱讀**：本節提供與該章相關的簡短參考資料列表。
- **關鍵詞**：每章使用的新術語列於章末，其定義包含在詞彙表中。
- **摘要**：每章結尾都有該章內容的摘要。
- **練習題**：每章都包含一組練習題，旨在鞏固重要概念並鼓勵學生應用。它由三部分組成：測驗、問題和習題。
