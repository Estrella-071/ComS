...
export const chapterList = [
    ...
    { id: 'chapter7', title: { en: 'Chapter 7: Operating Systems', zh: '第七章：作業系統' }, subtitle: { en: 'Components, evolution, and major OSs', zh: '組件、演進與主要作業系統' }, highlight: true },
    { id: 'chapter8', title: { en: 'Chapter 8: Algorithms', zh: '第八章：演算法' }, subtitle: { en: 'Constructs, representation, sorting, and searching', zh: '建構、表示法、排序與搜尋' }, highlight: true },
    { 
        id: 'chapter9', 
        title: { en: 'Chapter 9: Algorithm Efficiency', zh: '第九章：演算法效率' }, 
        subtitle: { en: '5th Edition Textbook Addition', zh: '第5版教科書新增' },
        disabled: true
    },
    { id: 'chapter10', title: { en: 'Chapter 10: Programming Languages', zh: '第十章：程式語言' }, subtitle: { en: 'Evolution, paradigms, and common concepts', zh: '演進、範式與共同概念' }, highlight: true },
    { id: 'chapter11', title: { en: 'Chapter 11: Software Engineering', zh: '第十一章：軟體工程' }, subtitle: { en: 'Lifecycle, analysis, design, and testing', zh: '生命週期、分析、設計與測試' } },
    { id: 'chapter12', title: { en: 'Chapter 12: Data Structure', zh: '第十二章：資料結構' }, subtitle: { en: 'Arrays, records, and linked lists', zh: '陣列、記錄與鏈結串列' }, highlight: true },
    { id: 'chapter13', title: { en: 'Chapter 13: Abstract Data Types', zh: '第十三章：抽象資料型別' }, subtitle: { en: 'Stacks, queues, lists, trees, and graphs', zh: '堆疊、佇列、串列、樹與圖' }, highlight: true },
    { id: 'chapter14', title: { en: 'Chapter 14: File Structure', zh: '第十四章：檔案結構' }, subtitle: { en: 'Sequential, indexed, and hashed files', zh: '循序、索引與雜湊檔案' } },
    { id: 'chapter15', title: { en: 'Chapter 15: Databases', zh: '第十五章：資料庫' }, subtitle: { en: 'Database models and relational databases', zh: '資料庫模型與關聯式資料庫' }, highlight: true },
    { id: 'chapter16', title: { en: 'Chapter 16: Data Compression', zh: '第十六章：資料壓縮' }, subtitle: { en: 'Lossless and lossy compression techniques', zh: '無損與失真壓縮技術' } },
    { id: 'chapter17', title: { en: 'Chapter 17: Security', zh: '第十七章：安全性' }, subtitle: { en: 'Confidentiality, integrity, and availability', zh: '機密性、完整性與可用性' } },
    { id: 'chapter18', title: { en: 'Chapter 18: Theory of Computation', zh: '第十八章：計算理論' }, subtitle: { en: 'Simple Language, Turing machines, halting problem', zh: '簡單語言、圖靈機、停機問題' } },
    {
        id: 'chapter19',
        title: { en: 'Chapter 19: Computer Graphics', zh: '第十九章：計算機圖學' },
        subtitle: { en: '5th Edition Textbook Addition', zh: '第5版教科書新增' },
        disabled: true
    },
    { id: 'chapter20', title: { en: 'Chapter 20: Artificial Intelligence', zh: '第二十章：人工智慧' }, subtitle: { en: 'Knowledge representation, expert systems, and search', zh: '知識表示、專家系統與搜尋' } },
    { id: 'chapter21', title: { en: 'Chapter 21: Introduction to Social Media', zh: '第二十一章：社群媒體簡介' }, subtitle: { en: 'Concepts behind Facebook and Twitter', zh: 'Facebook 與 Twitter 背後的概念' } },
    { id: 'chapter22', title: { en: 'Chapter 22: Social and Ethical Issues', zh: '第二十二章：社會與倫理議題' }, subtitle: { en: 'Principles, property, privacy, and crime', zh: '原則、財產、隱私與犯罪' } },
...
export const textbookData = {
    ...
    'chapter9': { title: chapterList[9].title, content: { en: '', zh: '' } }, // Placeholder
    'chapter10': { title: chapterList[10].title, content: chapter9Content }, // Shifted
    'chapter11': { title: chapterList[11].title, content: chapter10Content }, // Shifted
    'chapter12': { title: chapterList[12].title, content: chapter11Content }, // Shifted
    'chapter13': { title: chapterList[13].title, content: chapter12Content }, // Shifted
    'chapter14': { title: chapterList[14].title, content: chapter13Content }, // Shifted
    'chapter15': { title: chapterList[15].title, content: chapter14Content }, // Shifted
    'chapter16': { title: chapterList[16].title, content: chapter15Content }, // Shifted
    'chapter17': { title: chapterList[17].title, content: chapter16Content }, // Shifted
    'chapter18': { title: chapterList[18].title, content: chapter17Content }, // Shifted
    'chapter19': { title: chapterList[19].title, content: { en: '', zh: '' } }, // Placeholder Graphics
    'chapter20': { title: chapterList[20].title, content: chapter18Content }, // Shifted AI
    'chapter21': { title: chapterList[21].title, content: chapter19Content }, // Shifted Social Media
    'chapter22': { title: chapterList[22].title, content: chapter20Content }, // Shifted Social/Ethical
    'appendixA': { title: chapterList[23].title, content: appendixAContent },
    'appendixB': { title: chapterList[24].title, content: appendixBContent },
    'appendixC': { title: chapterList[25].title, content: appendixCContent },
    'appendixD': { title: chapterList[26].title, content: appendixDContent },
    'appendixE': { title: chapterList[27].title, content: appendixEContent },
    'appendixF': { title: chapterList[28].title, content: appendixFContent },
    'appendixG': { title: chapterList[29].title, content: appendixGContent },
    'appendixH': { title: chapterList[30].title, content: appendixHContent },
    'appendixI': { title: chapterList[31].title, content: appendixIContent },
    'appendixJ': { title: chapterList[32].title, content: appendixJContent },
    'acronyms': { title: chapterList[33].title, content: acronymsContent },
    'glossary': { title: chapterList[34].title, content: glossaryChapterContent },
};
